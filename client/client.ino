...
void setup() {
  ...
  xTaskCreate(check_motion, "Check IOT motion", 8000, NULL, 1, &TaskHandle_1);  // Needs to be above 4000
  xTaskCreate(check_CAP, "Check Control Accounts Payable", 8000, NULL, 1, &TaskHandle_2);
}
